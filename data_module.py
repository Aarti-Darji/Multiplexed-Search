    ...
    def setup(self, stage=None):
        ...
        # Determining transformations to apply.
              ...
              if self.normalize_transform:
                  ...
                  std = np.loadtxt(path.join("/home/acd9300/projects/project2/compressed_images_codex/codexlogs/MPIR/tonsil_logs/codex_Tonsil_combined/stat", "std.gz"))
                  mean = np.loadtxt(path.join("/home/acd9300/projects/project2/compressed_images_codex/codexlogs/MPIR/tonsil_logs/codex_Tonsil_combined/stat", "mean.gz"))
